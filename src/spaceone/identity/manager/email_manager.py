...
class EmailManager(BaseManager):
    ...
    def send_reset_password_email(self, user_id, email, reset_password_link, language):
        ...
        with self.smtp_connector as smtp_connector:
            smtp_connector.send_email(email, subject, email_contents)
    ...
    def send_domain_app_expiration_email(
        self,
        user_id: str,
        days_left: int,
        app_id: str,
    ...
    def send_workspace_app_expiration_email(
        self,
        user_id: str,
        days_left: int,
        app_id: str,
