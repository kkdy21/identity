...
class UserService(BaseService):
    ...
    def create(self, params: UserCreateRequest) -> Union[UserResponse, dict]:
        ...
        Args:
            params (UserCreateRequest): {
                ...
                'enforce_mfa': 'bool',
                'enforce_mfa_type': 'str'    # optional required
            }
        Returns:
            UserResponse:
        """
    ...
    def create_user(self, params: dict) -> User:
        ...
        mfa_enforce = params["enforce_mfa"]
    ...
    def update(self, params: UserUpdateRequest) -> Union[UserResponse, dict]:
        ...
        _LOGGER.info(f"@@@@@ params.enforce_mfa : {params.enforce_mfa}")
        _LOGGER.info(f"@@@@@ params.enforce_mfa_type : {params.enforce_mfa_type}")
        ...
        if params.enforce_mfa is not None:
            mfa_enforce = params.enforce_mfa
